...
export default function SpotifyDeck() {
  ...
  return (
    <div className="fixed bottom-20 left-1/2 transform -translate-x-1/2 z-40 w-[90%] max-w-sm">
      <div className="bg-gradient-to-br from-zinc-900/95 via-black/95 to-zinc-950/95 backdrop-blur-xl border border-zinc-800/50 rounded-2xl p-4 space-y-4 shadow-2xl">
        ...
        <div className="flex items-center justify-center gap-3">
          <button
            ...
            className="p-2.5 rounded-full text-zinc-400 hover:text-white hover:bg-zinc-800/50 transition-all disabled:opacity-50"
          >
          ...
          <button
            ...
            disabled={loading || !spotifyToken}
            className="p-3.5 rounded-full bg-[#1DB954] hover:bg-[#1ed760] text-black transition-all active:scale-95 disabled:opacity-50"
          >
            {isPlaying ? (
        ...
        <div className="space-y-2 px-1">
          <div className="flex items-center gap-2">
            ...
            <input
              ...
              className="flex-1 h-1.5 bg-zinc-800 rounded-full appearance-none cursor-pointer accent-[#1DB954] disabled:opacity-50"
            />
